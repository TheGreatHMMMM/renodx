...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        .key = "ColorGradeGamutCompressionMode",
        .binding = &shader_injection.tone_map_gamut_compression_mode,
        .value_type = renodx::utils::settings::SettingValueType::INTEGER,
        .default_value = 1.f,
        .label = "Gamut Compression Mode",
        .section = "Color Grading",
        .tooltip = "PsychoV24: Bounding gamut used for gamut compression.",
        .labels = {"BT.709", "BT.2020"},
        .is_enabled = []() { return shader_injection.tone_map_type == 2.f; },
    },
    new renodx::utils::settings::Setting{
        .key = "ColorGradeCompression",
        .binding = &shader_injection.tone_map_compression,
        .default_value = 100.f,
        .label = "Compression",
        .section = "Color Grading",
        .tooltip = "PsychoV24: Highlight compression power. Set to 0 for automatic.",
        .max = 100.f,
        .is_enabled = []() { return shader_injection.tone_map_type == 2.f; },
        .parse = [](float value) { return value * 0.01f; },
    },
